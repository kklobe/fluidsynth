...
{
    auto node = static_cast<fluid_setting_node_t *>(value);
                   ...
                   fluid_setting_node_t **value)
{
    ...
    for(n = 0; n < ntokens; n++)
    {
        ...
        node = static_cast<fluid_setting_node_t *>(fluid_hashtable_lookup(table, tokens[n]));
 ...
 */
int
fluid_settings_getstr_default(fluid_settings_t *settings, const char *name, const char **def)
{
    fluid_setting_node_t *node;
                             ...
                             const char *separator)
{
    ...
    {
        option = static_cast<char *>(fluid_list_get(p));
    ...
    str = static_cast<char *>(FLUID_MALLOC(len));
...
{
    auto bag = static_cast<fluid_settings_foreach_bag_t *>(data);
    auto keystr = static_cast<char *>(key);
    auto node = static_cast<fluid_setting_node_t *>(value);
    size_t pathlen;
    char *s;
