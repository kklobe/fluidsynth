...
{
    if(delete_fluid_defsfont(static_cast<fluid_defsfont_t *>(fluid_sfont_get_data(sfont))) != FLUID_OK)
    {
        return -1;
    }
...
{
    return fluid_defsfont_get_name(static_cast<fluid_defsfont_t *>(fluid_sfont_get_data(sfont)));
}

fluid_preset_t *
fluid_defsfont_sfont_get_preset(fluid_sfont_t *sfont, int bank, int prenum)
{
    return fluid_defsfont_get_preset(static_cast<fluid_defsfont_t *>(fluid_sfont_get_data(sfont)), bank, prenum);
}

void fluid_defsfont_sfont_iteration_start(fluid_sfont_t *sfont)
{
    fluid_defsfont_iteration_start(static_cast<fluid_defsfont_t *>(fluid_sfont_get_data(sfont)));
}

fluid_preset_t *fluid_defsfont_sfont_iteration_next(fluid_sfont_t *sfont)
{
    return fluid_defsfont_iteration_next(static_cast<fluid_defsfont_t *>(fluid_sfont_get_data(sfont)));
}
...
void fluid_defpreset_preset_delete(fluid_preset_t *preset)
{
    ...
    defsfont = static_cast<fluid_defsfont_t *>(fluid_sfont_get_data(preset->sfont));
    defpreset = static_cast<fluid_defpreset_t *>(fluid_preset_get_data(preset));
...
{
    return fluid_defpreset_get_name(static_cast<fluid_defpreset_t *>(fluid_preset_get_data(preset)));
}

int fluid_defpreset_preset_get_banknum(fluid_preset_t *preset)
{
    return fluid_defpreset_get_banknum(static_cast<fluid_defpreset_t *>(fluid_preset_get_data(preset)));
}

int fluid_defpreset_preset_get_num(fluid_preset_t *preset)
{
    return fluid_defpreset_get_num(static_cast<fluid_defpreset_t *>(fluid_preset_get_data(preset)));
}

int fluid_defpreset_preset_noteon(fluid_preset_t *preset, fluid_synth_t *synth,
                                  int chan, int key, int vel)
{
    return fluid_defpreset_noteon(static_cast<fluid_defpreset_t *>(fluid_preset_get_data(preset)), synth, chan, key, vel);
}
...
int delete_fluid_defsfont(fluid_defsfont_t *defsfont)
{
    ...
    {
        delete_fluid_inst(static_cast<fluid_inst_t *>(fluid_list_get(list)));
    }
...
int fluid_defsfont_load_all_sampledata(fluid_defsfont_t *defsfont, SFData *sfdata)
{
    ...
    for(list = defsfont->sample; list; list = fluid_list_next(list))
    {
        sample = static_cast<fluid_sample_t *>(fluid_list_get(list));
...
fluid_defpreset_noteon(fluid_defpreset_t *defpreset, fluid_synth_t *synth, int chan, int key, int vel)
{
    ...
    while(preset_zone != NULL)
    {
        ...
        if(fluid_zone_inside_range(&preset_zone->range, tuned_key, vel))
        {
            ...
            {
                voice_zone = static_cast<fluid_voice_zone_t *>(fluid_list_get(list));
...
fluid_inst_import_sfont(int inst_idx, fluid_defsfont_t *defsfont, SFData *sfdata)
{
    ...
    {
        sfinst = static_cast<SFInst *>(fluid_list_get(inst_list));
...
fluid_inst_zone_import_sfont(fluid_inst_zone_t *inst_zone, fluid_inst_zone_t *global_inst_zone, SFZone *sfzone, fluid_defsfont_t *defsfont, SFData *sfdata)
{
    ...
    if (inst_zone->gen[GEN_SAMPLEID].flags == GEN_SET)
    {
        ...
        {
            sfsample = static_cast<SFSample *>(fluid_list_get(list));
...
static fluid_inst_t *find_inst_by_idx(fluid_defsfont_t *defsfont, int idx)
{
    ...
    {
        inst = static_cast<fluid_inst_t *>(fluid_list_get(list));
