...
{
    auto iir_filter = static_cast<fluid_iir_filter_t *>(obj);
    auto type = static_cast<enum fluid_iir_filter_type>(param[0].i);
    auto flags = static_cast<enum fluid_iir_filter_flags>(param[1].i);
