...
{
    auto buffers = static_cast<fluid_rvoice_buffers_t *>(obj);
...
{
    auto voice = static_cast<fluid_rvoice_t *>(obj);
...
{
    auto rvoice = static_cast<fluid_rvoice_t *>(obj);
...
DECLARE_FLUID_RVOICE_FUNCTION(fluid_rvoice_set_interp_method)
{
    ...
    voice->dsp.interp_method = static_cast<fluid_interp>(value);
}
...
{
    auto voice = static_cast<fluid_rvoice_t *>(obj);
    auto value = static_cast<enum fluid_loop>(param[0].i);
...
{
    auto voice = static_cast<fluid_rvoice_t *>(obj);
    auto value = static_cast<fluid_sample_t *>(param[0].ptr);
